...
ActiveRecord::Schema.define(version: 2023_04_06_071201) do
  ...
  create_table "followings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["email"], name: "index_followings_on_email", unique: true
    t.index ["reset_password_token"], name: "index_followings_on_reset_password_token", unique: true
  end
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.index "\"reset_password_token\"", name: "index_notifications_on_reset_password_token", unique: true
  end
